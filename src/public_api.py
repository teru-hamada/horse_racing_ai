...
load_race_odds = _storage.load_race_odds
...
RESULT_STATUS_LABELS = _prediction_comparison.RESULT_STATUS_LABELS
...
calculate_bet_recommendations = _betting.calculate_bet_recommendations
